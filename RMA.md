---
title: |
    <span id="_Hlk482698107" class="anchor"></span>Resilience Modeling for
...
-   **I** – Incorrectness: corruption, version mismatch, sequence
    errors, duplicates

-   **A** – failure of Authorization or Authentication

-   **L** – Latency; slow or no response, flooding, deadlocks, metering,
    timeouts
...
-   client access auth failure – client service logs config error
    ...
    -   error on notify – receiver logs error (we may consider retries
        > here before failing)

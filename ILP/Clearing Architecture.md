...
| [ILP Client][]     | A standard JavaScript library used within the ILP Service. |
...
A custom application defined by the Level One Project that handles the planning of payments on an end-to-end basis. Part of the DFSP software. TODO: proper link

...
- Complete working open-source implementations of both sides of the interfaces: An example DFSP that can send and receive payments, and the portals that an existing DFSP could host to connect to the network.

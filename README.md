...
The Level One Project advocates and promotes financial inclusion for everyone. Today, more than two billion adults have neither a bank account nor access to a formal financial institution. The Level One Project intends to rectify this situation by making banking accessible to anyone who has a standard flip-phone.  Our project is aimed at building a national digital financial solution that is open to all.  Specifically, any person in any location with a phone can open a back account, send money, receive money or get paid for services. This open system will help the poorest people in the most remote locations to gain access to financial infrastructure.  
...
This project started with a model and prototype for a financial system that could be implemented in any country.  This code takes the model a step further by implementing a strong reliable messaging using the [Interledger](http://interledger.org) protocol as well as a functioning central hub to which financial providers can connect to facilitate common settlement and regulatory compliance.

> In order to expand this service and ensure a level playing field for everyone we need your help to enhance this project and help. Together we can realize the vision of having one digital financial system in every country around the world.
...
## System-wide Testing
Individual services have their own tests, but the [testing strategy](https://github.com/LevelOneProject/Docs/wiki/Manual-and-automated-testing-strategy) also includes the following system-wide tests:

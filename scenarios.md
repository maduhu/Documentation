The Level One Project handles several different scenarios to aid the poor in meeting their financial and banking needs.  While there are several different paths for each of these scenarios, including potential timeout issues and reversals (which are handled as a seperate transaction); we only outlined the most common path to help articulate the system capabilities.

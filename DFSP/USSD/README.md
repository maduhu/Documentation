...
#### 1.3 On the following screen the user must enter their first name.

![](./NewUserFirstName.PNG)

#### 1.4 On the following screen the user must enter their last name.

![](./NewUserLastName.PNG)

#### 1.5 On the following screen the user must enter their date of birth.

![](./NewUserDoB.PNG)

#### 1.6 On the following screen the user must enter their national ID.

![](./NewUserNatID.PNG)

#### 1.7 On the following screen the user must provide a PIN.

![](./NewUserPIN.PNG)

#### 1.8 On the following screen the user must provide an account name.
...
#### 2.2 On the following screen the user has to enter the destination account number.

![](./SendMoney2.JPG)

#### 2.3 The system displays the name of the user who is going to receive the money and the currency its account. Then the user has to enter the amount that to send.
...
#### 2.5 The system displays a final screen with the transaction status, the recipient name, the amount and the currency. The user can return to the home screen execute another transaction.
...
#### 3.2 On the following screen the merchant has to enter the amount of the invoice.
...
#### 4.2 On the following screen the system displays the name of the merchant and the amount of the invoice to be paid. The user has to confirm by entering his PIN, or he can reject by selecting the 'Reject' menu item.
